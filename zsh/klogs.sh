...
echo "Write pod’s number you want to show logs..."
read  ELECCION;
...
echo "Write container’s number you want to show logs..."
read  ELECCIONCONTAINER;

echo "You’ve chosen  pod $ELECCION: $OUTPUT[ELECCION] $ESPACIO_NOMBRE_VAR container $ELECCIONCONTAINER: $TOTALCONTAINERS[ELECCIONCONTAINER]"

COMANDOFINAL="kubectl logs -f $OUTPUT[ELECCION] $TOTALCONTAINERS[ELECCIONCONTAINER]"
